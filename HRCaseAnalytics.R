################################### - Course 3 - HR Analytics Case Study ################################################
# Using Logistic Regression

#---------------- Setting Environments for Loading and Analsis of the loan data.---------------#
# Define used libraries
useLib <- 
  c("dplyr","ggplot2","stringr","caret","tidyr","e1071","car","MASS","ROCR","caTools","scales","stats","cowplot")
...
# Steps followed during the execution of this Case Study:
...
#============================================== [I] Business Understanding: =======================================================================================================================================================================
# To summarize from the problem statement given, there is a large company 'XYZ', provides employment for approximately 4000 individuals. However, in recent years it is faced with the challenge of high annual attrition rate of approximately 15%.
...
# Since Employee_ID is the primary key across all the tables and the setdiff() returns the value zero implying that 
# the same set of 4410 Employee_ID are present in all the 5 tables.
...
# The datachop function checks all the records of each column for more than 1 unique value, 
# if there is only one unique value or NA it deletes that column from the loan_dataset. 
# The logical(1L) argument specifies that the length function should return a logical value of length 1 integer.
...
# Summary:
# Employees who travel rarely have the highest count of attrition. 
# However when looking at the proportion 24.9% employees who travel frequently and 15% of employees who travel rarely 
# are likely to attrition
